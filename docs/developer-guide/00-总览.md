...
| 文档 | 内容 |
|---|---|
| [Agent Loop 详解](./agent-loop.md) | `AIAgent` 主循环的逐步解析 |
| [Transport 传输层](./architecture.md) | 多提供商适配的底层实现 |
| [Tool System 工具系统](./tools-runtime.md) | 工具注册、发现、调度的运行时机制 |
| [Gateway 网关架构](./gateway-internals.md) | 多平台消息路由的完整链路 |
| [Memory 记忆系统](./memory-provider-plugin.md) | 记忆提供商的开发与集成 |
| [Context Compression](./context-compression-and-caching.md) | 上下文压缩算法与缓存策略 |
| [Prompt Assembly](./prompt-assembly.md) | 系统提示词的组装流程 |
